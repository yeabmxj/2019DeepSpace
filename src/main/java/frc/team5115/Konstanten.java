...
public class Konstanten {
    ...
    private static final double MIN_HEIGHT = 54;
    public static final double MIN_SCALED = 0;
    public static final double LEVEL1 = 0.4;
    public static final double LEVEL2 = 0.55;
    public static final double BALLPICKUP = 1.1;
    public static final double LEVEL3 = 1.4;
    public static final double LEVEL4 = 1.6;
    public static final double LEVEL5 = 2.5;
    public static final double LEVEL6 = 2.7;
    ...
    //Wrist
    public static final int WRIST_X = 0;
    public static final int WRIST_Y = 1;
